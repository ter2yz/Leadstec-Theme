<section class="relative w-full overflow-hidden">
    ...
    <div class="hidden md:flex w-full" style="background-color: <?php echo $brands[0]['background_color'] ?>">
        <div class="relative w-[91%] max-w-none lg:max-w-[1112px] mx-auto flex flex-col items-start py-16 lg:py-32 overflow-hidden">
            ...
            <h3 class="relative max-w-sm md:max-w-[350px] lg:max-w-[640px] font-bold text-[26px] text-left leading-snug text-[#1b1c1d] mb-20 z-20"><?php echo $brands[0]['description'] ?></h3>
            <?php if($brands[0]['button_url'] && $brands[0]['button_label']): ?>
            <div class="w-60 grow flex justify-start items-end">
                <a href="<?php echo $brands[0]['button_url'] ?>" class="text-white flex justify-center items-center border-2 border-zinc-900 bg-zinc-900 px-6 py-2 z-20">
    ...
    <div class="hidden md:flex w-full justify-center items-stretch">
        ...
        ?>
            <div class="relative w-full flex flex-col items-start py-16 lg:py-32 px-16 overflow-hidden" style="background-color: <?php echo $brand['background_color'] ?>">
                ...
                <h3 class="relative max-w-sm md:max-w-[350px] lg:max-w-[640px] font-bold text-[26px] text-left leading-snug text-[#1b1c1d] mb-20 z-20"><?php echo $brand['description'] ?></h3>
                <?php if($brand['button_url'] && $brand['button_label']): ?>
                <div class="w-60 grow flex justify-start items-end">
                    <a href="<?php echo $brand['button_url'] ?>" class="text-white flex justify-center items-center border-2 border-zinc-900 bg-zinc-900 px-6 py-2 z-20">
        ...
        <div id="slider-brands-cta" class="w-full my-slider">
            ...
            ?>
                <div class="relative w-full flex flex-col items-start py-16 lg:py-32 px-16 overflow-hidden" style="background-color: <?php echo $brand['background_color'] ?>">
                    ...
                    <h3 class="relative max-w-sm font-bold text-xl text-left leading-snug text-zinc-900 mb-20 z-20"><?php echo $brand['description'] ?></h3>
                    <?php if($brand['button_url'] && $brand['button_label']): ?>
                    <div class="w-60 grow flex justify-start items-end">
                        <a href="<?php echo $brand['button_url'] ?>" class="text-white flex justify-center items-center border-2 border-zinc-900 bg-zinc-900 px-6 py-2 z-20">
                            <?php echo $brand['button_label'] ?>
