    ...
    <div class="hidden md:flex w-full justify-center items-stretch">
        ...
        ?>
            <div class="relative w-full flex flex-col items-start py-16 lg:py-32 px-16 overflow-hidden" style="background-color: <?php echo $brand['background_color'] ?>">
                <img class="h-8 mb-12" src="<?php echo esc_url( $brand['logo'] ); ?>" alt="">
                <h3 class="max-w-sm font-bold text-xl text-left capitalize leading-snug text-zinc-900 mb-20"><?php echo $brand['description'] ?></h3>
                ...
                <div class="absolute h-2/3 bottom-6 -right-12 text-[26rem] font-black" style="color: <?php echo $brand['decoration_letter_color'] ?>">
