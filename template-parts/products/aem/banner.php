<section class="relative w-full flex justify-center bg-gray-400 py-28 bg-cover bg-center bg-no-repeat" aria-label="<?php echo get_field('banner')['image_alt_text'] ?>" style="background-image: url(<?php echo esc_url( get_field('banner')['background_image'] ); ?>); ">
