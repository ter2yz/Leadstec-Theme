<section class="w-full bg-white pt-10 pb-16 lg:pb-32">
    <div class="relative w-[91%] max-w-none lg:max-w-[1112px] mx-auto z-20">
        <div class="w-full flex flex-col items-center justify-center">
            <h2 class="w-full text-center text-[30px] md:text-[60px] text-[#1b1c1d] px-3 font-bold top-0 bg-white z-20"><?php echo get_field('best_on_market')['heading'] ?></h2>
        </div>
    </div>
    <!-- @TODO: Array begin -->
        ...
        <div class="w-full min-h-max px-3 flex flex-col justify-between items-center">
            ...
            <div class="w-full mt-12">
                <h3 class="relative capitalize text-[#1b1c1d] text-[20px] font-bold mb-6 text-center">
                    <?php echo $service['heading'] ?>
                    <span class="absolute left-1/2 top-0 -translate-y-1/2 text-7xl origin-bottom-left scale-110 -translate-x-1/2 font-bold text-zinc-800/5"><?php echo $service['blur_background_text'] ?></span>
                </h3>
