    ...
    <div id="slider-headless-best" class="w-full my-slider">
        ...
        <div class="w-full min-h-max px-3 flex flex-col justify-between items-center">
            ...
            <div class="w-full mt-9">
                <h3 class="relative capitalize text-gray-900 text-3xl font-semibold mb-6 text-center">
                    <?php echo $service['heading'] ?>
                ...
                <p class="text-gray-900 capitalize text-center"><?php echo $service['description'] ?></p>
            </div>
        </div>
        <?php
                }
