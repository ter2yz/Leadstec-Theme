            ...
            <div class="w-full lg:w-1/3 px-3 mb-6">
                <div class="w-full h-full bg-white flex flex-col border border-zinc-200">
                    ...
                    <div class="w-full flex flex-col justify-between items-start grow p-3 lg:p-6 xl:p-9">
                        <div class="w-full">
                            <h3 class="font-bold text-[20px] text-[#1b1c1d] text-left mb-3"><?php echo esc_html( $singlePost['post']->post_title ); ?></h3>
                            <p class="leading-relaxed text-[#9f9f9f] text-left mb-12 line-clamp-3"><?php echo get_the_excerpt($singlePost['post']); ?></p>
                        </div>
