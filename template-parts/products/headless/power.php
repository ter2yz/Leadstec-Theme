        ...
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <div class="w-full">
                ...
                <div class="w-full flex flex-col md:odd:flex-row md:even:flex-row-reverse justify-center items-center mb-12 group">
                    <div class="w-full md:max-w-[340px] lg:max-w-none h-0 pb-[30%] md:group-odd:mr-[28px] md:group-even:ml-[28px] lg:group-odd:mr-[50px] lg:group-even:ml-[50px] bg-cover bg-no-repeat bg-center" style="background-image: url(<?php echo esc_url( $card['image'] ); ?>);">
                    </div>
                    <div class="w-full py-9 md:py-0 md:group-odd:pl-[28px] md:group-even:pr-[28px] lg:group-odd:pl-[50px] lg:group-even:pr-[50px] flex flex-col items-start">
                        ...
                        <p class="text-[#9f9f9f] text-[15px] md:text-[20px] capitalize"><?php echo $card['description'] ?></p>
