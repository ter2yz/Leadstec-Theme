...
<section class="relative w-full pt-12 md:pt-20">
    <div class="w-[91%] max-w-none lg:max-w-[1112px] mx-auto">
        <h2 class="w-full capitalize text-[30px] md:text-[60px] text-center text-[#1b1c1d] font-bold mb-5 md:mb-10"><?php echo get_field('authoring_experience_section')['heading'] ?></h2>
    </div>
    <div class="flex w-full flex-row justify-start border-t border-zinc-100 flex-wrap items-stretch @container">
        ...
        <div class="w-full md:w-1/2 mx-auto group" style="--hover-color: <?php echo $card['hover_background_color'] ?>">
            <div class="card-wrapper w-full h-full py-16 md:py-32 px-0 md:group-odd:pl-[9%] md:group-odd:pr-16 md:group-even:pl-16 md:group-even:pr-[9%] xl:group-odd:pl-[calc(100%-556px)] xl:group-even:pr-[calc(100%-556px)] border-y md:odd:border-r border-zinc-100 bg-white transition duration-300 group">
