<section class="relative w-full flex justify-center items-center bg-cover bg-bottom py-20" style="background-image: url(<?php echo esc_url( get_field('hero_section')['background_image'] ); ?>)">
    ...
    <div class="container z-10">
        <div class="w-full flex flex-col-reverse lg:flex-row justify-start lg:justify-center items-center lg:min-h-[600px] overflow-hidden">
            <div class="relative w-full flex flex-col items-center z-10 text-white">
                ...
                <h1 class="text-5xl lg:text-7xl capitalize font-semibold leading-tight text-center"><?php echo esc_html(get_field('hero_section')['heading']) ?></h1>
                <span class="w-20 h-3 bg-transparent my-5"></span>
                <p class="leading-relaxed max-w-5xl text-center"><?php echo esc_html(get_field('hero_section')['description']) ?></p>
            </div>
        </div>
    </div>
