            ...
            <div class="relative w-full flex justify-center group transition duration-300 hover:bg-white overflow-hidden">
                <div class="relative container flex lg:group-odd:flex-row lg:group-even:flex-row-reverse group-odd:justify-start group-even:justify-end items-center z-10">
                    <div class="w-full md:group-even:w-7/12 lg:w-5/12 md:group-odd:pr-12 md:group-even:pl-12 lg:group-even:pl-20 min-h-[181px] md:min-h-[385px] flex flex-col justify-center group-odd:items-start group-even:items-end">
                        ...
                        <p class="px-3 w-full md:max-w-[370px] text-white text-[15px] md:text-[20px] group-even:text-right transition duration-300 group-hover:text-zinc-900"><?php echo $culture['description'] ?></p>
                    </div>
