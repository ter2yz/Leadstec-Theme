    ...
    <div class="relative w-[91%] max-w-none lg:max-w-[1112px] mx-auto z-20">
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <div class="w-full flex flex-col lg:flex-row justify-center items-center mb-16 lg:mb-0">
                <img class="slider-single-image w-full mx-auto" src="<?php echo esc_url( get_field('history_section')['image'] ); ?>" alt="<?php echo get_field('history_section')['image_alt_text']; ?>">
            </div>
        </div>
    </div>
</section>
