...
<div id="page" class="min-h-screen flex flex-col">
	...
	<header class="relative z-40">
            ...
            <div class="container">
                <div class="w-full flex justify-between items-center">
                    ...
                    <div class="relative w-full flex justify-end items-center">
                        <div class="hidden lg:flex justify-center items-center">
                            <div class="group inline-block relative">
                                <a href="#" class="relative inline-flex w-full justify-center items-center gap-x-1.5 rounded-md bg-white px-3 py-3 text-lg <?php echo is_page_template( array('page-templates/page_adobe-experience-manager.php', 'page-templates/page_adobe-experience-cloud.php', 'page-templates/page_headless.php', 'page-templates/page_erp.php') ) ? "text-orange-500" : "text-zinc-900" ?> hover:text-orange-500 transition-colors group" id="menu-products" aria-expanded="true" aria-haspopup="true">
                                    Products
                                    <svg class="-mr-1 h-5 w-5 text-gray-400 group-hover:text-orange-400 transition rot group-hover:rotate-180" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                                    </svg>
                                    <span class="absolute bottom-2 left-3 w-1 h-1 bg-orange-400 rounded-full transition duration-300 opacity-0 group-hover:opacity-100"></span>
                                    <span class="absolute bottom-2 left-3 w-1 h-1 bg-orange-400 rounded-full transition duration-300 opacity-0 translate-x-0 group-hover:opacity-100 group-hover:translate-x-2"></span>
                                    <span class="absolute bottom-2 left-3 w-1 h-1 bg-orange-400 rounded-full transition duration-300 opacity-0 translate-x-0 group-hover:opacity-100 group-hover:translate-x-4"></span>
                                </a>
                                <div class="absolute left-1/2 -translate-x-1/2 top-full z-10 w-56 p-3 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden group-hover:block" role="menu" aria-labelledby="menu-products" tabindex="-1">
                                    ...
                                    <a href="/products/adobe-experience-manager/" class="text-zinc-500 block px-4 py-2 hover:bg-orange-50 transition" role="menuitem" tabindex="-1" id="menu-item-0">Aem</a>
                                    <a href="/products/adobe-experience-cloud/" class="text-zinc-500 block px-4 py-2 hover:bg-orange-50 transition" role="menuitem" tabindex="-1" id="menu-item-0">Adobe Experience Cloud</a>
                                    <a href="/products/headless-cms/" class="text-gray-700 block px-4 py-2 font-medium hover:bg-orange-50 transition" role="menuitem" tabindex="-1" id="menu-item-1">Magnolia CMS</a>
                                    <a href="/products/erp/" class="text-gray-700 block px-4 py-2 font-medium hover:bg-orange-50 transition" role="menuitem" tabindex="-1" id="menu-item-2">ERP Products</a>
                                </div>
                            </div>
                            <div class="group inline-block relative">
                                ...
                                <div class="absolute left-1/2 -translate-x-1/2 top-full z-10 p-3 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden group-hover:block" role="menu" aria-labelledby="menu-products" tabindex="-1">
                                    <a href="/services/adobe-solution-partner/" class="capitalize text-zinc-500 block px-4 py-2 hover:bg-orange-50 transition whitespace-nowrap" role="menuitem" tabindex="-1" id="menu-item-0">Adobe Solution Partner</a>
                                    <a href="/services/web-design-and-development/" class="capitalize text-zinc-500 block px-4 py-2 hover:bg-orange-50 transition whitespace-nowrap" role="menuitem" tabindex="-1" id="menu-item-0">Website Design & Developement</a>
                                </div>
                            </div>
                            
                            <a href="/successful-stories/" class="cursor-pointer">
                            ...
                            <a href="/blogs-list/" class="cursor-pointer">
                        ...
                        <div class="pl-6 flex md:hidden justify-center items-center">
        ...
        <div id="nav-menu-mobile" class="block md:hidden w-full absolute left-0 top-full bg-white shadow-lg overflow-hidden opacity-0 max-h-0 transition-all duration-300 rounded-b-lg">
                ...
                <div class="menu-item w-full flex items-start justify-center group">
                    ...
                    <div class="flex grow flex-col items-start ml-3">
                        ...
                        <div class="w-full flex justify-between items-center">
                            ...
                            <svg class="h-5 w-5 -mt-1 text-gray-400 group-[.active]:text-orange-400 transition rotate-0 group-[.active]:rotate-180" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                            </svg>
                        </div>
