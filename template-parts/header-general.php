                    ...
                    <div class="relative w-full flex justify-end items-center">
                        <div class="hidden lg:flex justify-center items-center">
                            ...
                            <div class="group inline-block relative">
                                ...
                                <?php if($f_item['second_level_items']): ?>
                                <div class="absolute left-1/2 -translate-x-1/2 top-full z-10 w-56 p-3 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none hidden group-hover:block max-h-[80vh] overflow-y-auto" role="menu" aria-labelledby="menu-products" tabindex="-1">
