<section id="<?php echo get_sub_field('id')?>" class="relative w-full flex justify-center bg-gray-100 py-12 md:py-20">
    <div class="relative container z-20">
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <p class="text-[#9f9f9f] text-[15px] md:text-[20px] max-w-3xl text-center mb-[44px]"><?php echo get_sub_field('description') ?></p>
            <div class="video-wrapper relative w-full max-w-5xl h-0 pb-[45%] bg-zinc-300 flex justify-center items-center">
