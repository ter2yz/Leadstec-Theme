<section id="<?php echo get_sub_field('id')?>" class="relative w-full flex flex-col items-center justify-center bg-gray-100 pt-12 pb-10 md:pt-20 md:pb-20 overflow-hidden">
    ...
    <!-- Mobile Carousel -->
    <div class="ms-fw-container block lg:hidden w-full overflow-auto md:touch-none cursor-grab no-scrollbar">
