<section id="<?php echo get_sub_field('id')?>" class="relative w-full bg-gray-200 overflow-hidden">
    <div class="relative z-20">
        <div class="w-full pt-32 pb-20 lg:pt-48 lg:pb-40 flex flex-col items-center justify-center">
            <h2 class="capitalize text-[30px] md:text-[60px]  text-[1b1c1d] font-semibold text-center -mt-16 px-2"><?php echo get_sub_field('heading'); ?></h2>
            <div id="solutions-fw-container" class="block lg:hidden w-full overflow-auto md:touch-none cursor-grab no-scrollbar">
                <div id="solutions-container" class="w-[91%] max-w-none lg:max-w-[1112px] mx-auto">
                    <div id="solutions-wrap" class="inline-flex flex-nowrap mt-[20px] md:mt-[40px]">
                        ...
                        ?>
                            <?php if($solution['url']): ?>
                            <a href="<?php echo $solution['url']; ?>" class="w-[96px] md:w-[166px] lg:w-[200px] mr-[12px] last:mr-0 flex-none" <?php echo $solution['is_open_via_new_tab'] ? 'target="_blank"' : ''; ?>>
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                                <div class="solution-brand w-full lg:min-w-min flex flex-col items-center h-full group">
                                    <div class="w-full h-[96px] md:h-[166px] lg:h-[200px] p-3 lg:p-10 bg-white flex-none flex justify-center items-center">
                                        <img class="w-full h-full object-center object-contain" src="<?php echo esc_url($solution['logo']['url']); ?>" alt="<?php echo $solution['image_alt_text']; ?>">
                                    </div>
                                    <div class="w-full bg-gray-100 flex justify-center grow items-center p-3 md:p-6 font-bold">
                                        <p class="solution-brand-label opacity-50 transition duration-300 text-center group-hover:opacity-100 text-[12px] md:text-[20px] text-[1b1c1d]"><?php echo $solution['name'] ?></p>
                                    </div>
                                </div>
                            <?php if($solution['url']): ?>
                            </a>
            ...
            <div class="hidden lg:block w-[91%] max-w-none lg:max-w-[1112px] mx-auto mt-10">
                ...
                ?>
                    <?php if($solution['url']): ?>
                    <a href="<?php echo $solution['url']; ?>" class="w-1/5 px-2 mb-3 flex-none" <?php echo $solution['is_open_via_new_tab'] ? 'target="_blank"' : ''; ?>>
                    <?php else: ?>
