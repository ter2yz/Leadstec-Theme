                            ...
                            <?php endif; ?>
                                <div class="solution-brand w-full lg:min-w-min flex flex-col items-center h-full group">
                                    ...
                                    <div class="w-full bg-gray-100 flex justify-center grow items-center p-3 md:p-6 font-bold">
                                        <p class="solution-brand-label opacity-50 transition duration-300 text-center group-hover:opacity-100 text-[10px] md:text-[20px] text-[1b1c1d]"><?php echo $solution['name'] ?></p>
                                    </div>
                                </div>
                            <?php if($solution['url']): ?>
                            </a>
