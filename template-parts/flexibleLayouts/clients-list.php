...
<section id="<?php echo get_sub_field('id')?>" class="relative w-full min-h-[500px] lg:min-h-screen bg-gradient-to-tr from-[#38B0F1] to-[#81E4E8]">
    ...
    <div class="w-full mt-20 px-2">
        <h2 class="capitalize text-[30px] md:text-[60px] text-white font-semibold text-center"><?php echo get_sub_field('heading'); ?></h2>
    </div>
    <div class="home-client w-full relative overflow-hidden mt-16 pb-32">
                        ...
                        ?>
                            <li class="splide__slide odd:translate-y-40 even:translate-y-5">
                                <div class="w-[120px] h-[120px] md:w-60 md:h-60 p-5 md:p-10 bg-white rounded-full flex justify-center items-center transition hover:scale-105 duration-300 <?php if($client['url']): ?>cursor-pointer<?php endif; ?>">
                                    ...
                                    <?php endif; ?>
                                    <img class="w-full" src="<?php echo esc_url( $client['image']['url'] ); ?>" alt="<?php echo $client['image_alt_text']; ?>">
                                    <?php if($client['url']): ?>
                                    </a>
                                    <?php endif; ?>
                                </div>
